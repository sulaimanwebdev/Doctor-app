...
const About = () => {
  return (
    ...
    <div className="bg-transparent w-full mt-14 lg:mt-20 relative">
    ...
    <div className="bg-transparent w-full mt-20 mb-20 relative">
    ...
    <div className="common-width bg-transparent flex items-center justify-center gap-5 w-full px-5 py-2 mx-auto">
     <div className="h-[450px] w-[450px] flex items-center justify-center relative">
     ...
     <div className='border-2 border-white/20 px-5 py-5'>
       ...
       <div className='text-[#3D5C70] font-[600] text-[18px] mt-6'>Our experience always guarantee quality</div>
       <div className='text-[#3D5C70] leading-relaxed text-[14.5px] mt-3'>Lorem ipsum dolor sit amet, consectetur adipiscing. </div>
     </div>
     <div className='px-5 py-5 footer-bg'>
       ...
       <div className='text-white font-[600] text-[18px] mt-6'>Our experience always guarantee quality</div>
       <div className='text-white leading-relaxed text-[14.5px] mt-3'>Lorem ipsum dolor sit amet, consectetur adipiscing. </div>
     </div>
     <div className='border-2 border-white/20 px-5 py-5'>
