...
const Contact = () => {
  return (
    ...
    <div className="common-width bg-transparent w-full px-5 py-20 mx-auto">
     <div className="bg-[#F8F9FA] mx-auto">
     <div className="grid grid-cols-[500px,1fr] w-full  mx-auto">
          <div className="relative h-[773px]">
          ...
          <div className="">
            <div className="h-[91px]"></div>
             <div className="py-10 px-12 bg-[#F2F4F5]">
