...
const Home = () => {
  return (
    ...
    <div className="common-width relative lg:min-h-[600px] flex items-center flex-col lg:flex-row gap-[60px]  w-full px-5 pt-1 mx-auto">
      <div className='z-10 mt-[40px] lg:mt-0'>
        <div className='font-[Ubuntu] font-[700] text-[32px] sm:text-[37px] text-[#3D5C70] leading-tight'>We Help Make Peoples<br/> Life Better</div>
      ...
      <img src="images/home.svg" className='w-[460px] lg:w-[570px] lg:absolute lg:-top-1 lg:-right-[35px] z-10' alt="doctor" />
    ...
    <div className="common-width bg-white flex items-center justify-center flex-col lg:flex-row gap-[60px]  w-full px-5 py-1 mx-auto">
      ...
      <img src="images/circle2.svg" className='w-[100px] hidden lg:block absolute -top-16 left-0' alt="circle" />
    </div>
    </div>
    ...
    <div className="text-center z-10 relative mb-16">
      ...
      <div className='font-[Ubuntu] font-[700] text-[29px] sm:text-[34px] text-[#3D5C70] leading-tight'>Delivering Personalized Healthcare to Every Patient</div>
       ...
       <div className="w-full grid grid-cols-4 gap-5 z-10 relative overflow-hidden">
